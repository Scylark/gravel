...
story.append(Paragraph(
    ...
    'cycling, endurance sport and fitness technology. Currently Marketing Consultant at Ribble Cycles and '
...
bullet('Ribble Outliers race programme - all four national titles at the 2026 UK Gravel National Championships, 2nd at the UCI Gralloch with Jenson Young, and a team film from The Traka in Girona, each turned into campaigns across owned and earned channels.')
...
# Muuvr
role('Muuvr - Swiss-Based Health & Wellbeing App', 'CMO', 'Jan 2023 - May 2024')
...
story.append(Paragraph(
    '<b>Personal Interests:</b> Gravel Racing - 9th (40-44), UK National Gravel Championships 2026 - Road Cycling - 15th at National Championships 2025 - XC MTB - Travel - Adventure Sports - Sustainability - Technology - AI',
    styles['CVSmall']
))
story.append(Paragraph(
